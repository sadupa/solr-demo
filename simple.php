...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Simple Search</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <h1>mysql</h1>
                <span id="mysqlTimer" class="text-success timer hidden"></span>
            ...
            <div class="col-md-6">
                ...
                <span id="solrTimer" class="text-success timer hidden"></span>
    ...
    <script type="text/javascript">
        ...
        function sendMysqlSearchRequest(query, limit) {
            ...
            $.ajax({
                ...
                data: {'q': query, 'action': action, 'limit': limit},
                dataType: 'json',
                beforeSend: function () {
